...
class Trace:
    ...
    def analysis(self) -> TraceAnalysis:
        from src.photoacoustic.analysis import analyze_time_trace
...
class MeasurementFile:
    ...
    def from_path(cls, path: Path):
        from src.photoacoustic.input import yield_individual_repeats, read
    ...
    def energy(self) -> Variable:
        from src.photoacoustic.analysis import ufloat_nanmean
...
class PowerScan:
    ...
    def analysis(self) -> PowerscanAnalysis:
        if self._analysis is None:
            from src.photoacoustic.analysis import analyze_powerscan
...
class Experiment:
    ...
    def from_path(cls, p: Path):
        from src.photoacoustic.input import read_absorbance
